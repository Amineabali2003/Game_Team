		...
		RYU1: {
			...
			states: {
				...
				light_boxing: {
					...
					framesNum: 3,
					easing: [ 0, 0, 3, 'linear' ],   //left, top, ���뻭һ��, �㷨,
					position: 7,
					attack_type: 2,
					attack_config: [ 10, 60, 110, 0, 100, 'linear', 'light', 'attacked_light_top', 20 ],  //ƫ��x, ƫ��y, left, top, timer, easing
				...
				near_light_boxing: {
					...
					near: 130,
					attack_type: 2,
					attack_config: [ 10, 45, 110, 0, 100, 'linear', 'light', 'attacked_light_top', 25 ],  //ƫ��x, ƫ��y, left, top, timer, easing
					attack_power: [ 1, false ],
				...
				heavy_boxing: {
					...
					position: 7,
					attack_type: 2,
					attack_config: [ 10, 60, 120, 0, 150, 'linear', 'heavy', 'attacked_heavy', 120 ],  //ƫ��x, ƫ��y, left, top, timer, easing
				...
				crouch_light_boxing: {
					...
					easing: [ 0, 0, 6, 'linear' ],
					attack_type: 2,
					attack_config: [ 10, 60, 150, 0, 150, 'linear', 'light', 'attacked_light_bottom', 30 ],  //ƫ��x, ƫ��y, left, top, timer, easing
				...
				crouch_heavy_boxing: {
					...
					easing: [ 0, 0, 6, 'linear' ],
					attack_type: 2,
					attack_config: [ 10, 60, 150, 0, 150, 'linear', 'heavy', 'attacked_heavy_bottom', 120 ],  //ƫ��x, ƫ��y, left, top, timer, easing
				...
				light_kick: {
					...
					position: -50,
					attack_type: 2,
					attack_config: [ 10, 40, 120, 0, 150, 'linear', 'light', 'attacked_light_top', 30 ],  //ƫ��x, ƫ��y, left, top, timer, easing
					attack_power: [ 1, false ],
					effect_position: [ 0, 0 ],
					sound: [ 'sound/light_boxing.mp3', 'sound/hit_light.mp3' ]
				},
				near_light_kick: {
					...
					near: 140,
					attack_type: 2,
					attack_config: [ 10, 150, 110, 0, 100, 'linear', 'light', 'attacked_light_bottom', 40 ],  //ƫ��x, ƫ��y, left, top, timer, easing
					attack_power: [ 1, false ],
				...
				crouch_light_kick: {
					...
					easing: [ 0, 0, 3, 'linear' ],
					attack_type: 2,
					attack_config: [ 10, 100, 210, 0, 150, 'linear', 'light', 'attacked_light_bottom', 40 ],  //ƫ��x, ƫ��y, left, top, timer, easing
					attack_power: [ 3, false ],
					effect_position: [ 0, 140 ],
					sound: [ 'sound/light_boxing.mp3', 'sound/hit_light.mp3' ]
				},
				heavy_kick: {
					...
					easing: [ 0, 0, 6, 'easeIn' ],
					attack_type: 2,
					attack_config: [ 10, 120, 160, -100, 200, 'linear', 'heavy', 'attacked_heavy_top', 150 ],  //ƫ��x, ƫ��y, left, top, timer, easing
					attack_power: [ 2, false ],
					effect_position: [ 0, -20 ],
				...
				near_heavy_kick: {
					...
					near: 160,
					attack_type: 2,
					attack_config: [ 10, 90, 110, 0, 150, 'linear', 'heavy', 'attacked_heavy_top', 160 ],  //ƫ��x, ƫ��y, left, top, timer, easing
					attack_power: [ 2, false ],
					effect_position: [ 0, -20 ],
					sound: [ 'sound/heavy_boxing.mp3', 'sound/hit_heavy_kick.mp3' ]
				},
				crouch_heavy_kick: {
					...
					easing: [ 0, 0, 6, 'easeIn' ],
					attack_type: 2,
					attack_config: [ 10, 50, 230, 0, 150, 'linear', 'heavy', 'crouch_kick_attacked_fall', 130 ],  //ƫ��x, ƫ��y, left, top, timer, easing
					attack_power: [ 4, false ],
					effect_position: [ 0, 140 ],
					sound: [ 'sound/heavy_boxing.mp3', 'sound/hit_heavy_kick.mp3' ]
				},
				...
				jump_light_impact_boxing: {
					...
					attack_type: 2,
					attack_config: [ 150, 130, 0, -120, 100, 'linear', 'heavy', 'heavy_attacked_fall_down', 150 ],  //ƫ��x, ƫ��y, left, top, timer, easing
					attack_power: [ 9, true ],
				...
				after_jump_light_impact_boxing: {
					...
					attack_type: 0,
					attack_power: [ 0, false ]  //power_level, �޵�.
				},
				...
				jump_whirl_kick: {
					...
					attack_type: 2,
					attack_config: [ 50, 120, 370, 0, 150, 'linear', 'heavy', 'heavy_attacked_fall_down', 180 ],  //ƫ��x, ƫ��y, left, top, timer, easing
